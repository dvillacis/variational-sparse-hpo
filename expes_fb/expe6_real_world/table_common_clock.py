...
EFF = [('n_iter', r'Outer it.', True, '.0f', False, True),
       ('t_per_iter', r't/iter (s) $\downarrow$', True, '.2f', True, True),
       ('elapsed', r'Total (s) $\downarrow$', True, '.1f', True, False)]
...
def build_s1():
    ...
    L = [r'\begin{table}[t]', r'  \centering',
         ...
         r'    clock: outer iterations run, wall-clock time per outer iteration, and total wall-clock',
         r'    time; \texttt{Sparse-HO}, \texttt{NTRBA}-null and \texttt{NTRBA} share an outer budget',
         ...
         r'    & & Recovery & Sparsity & Classification & Pred.\ loss & \multicolumn{3}{c}{Efficiency} \\',
...
def build_s2():
    ...
    L = [r'\begin{table}[t]', r'  \centering',
         r'  \setlength{\tabcolsep}{4pt}', r'  \small', r'  \caption{%',
         ...
         r'    as Table~\ref{tab:expe5_setting1}: outer iterations run, wall-clock per outer',
         r'    iteration, and total wall-clock. \texttt{Sparse-HO} and \texttt{NTRBA} share an outer',
         ...
         r'    & & \multicolumn{2}{c}{Quality} & \multicolumn{3}{c}{Efficiency} \\',
