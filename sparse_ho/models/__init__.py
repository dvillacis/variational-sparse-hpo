...
from sparse_ho.models.wenet import CelerWeightedElasticNet, WeightedElasticNet
from sparse_ho.models.wlogreg import WeightedSparseLogReg
...
__all__ = ['Lasso',
           ...
           'WeightedLasso',
           'SparseLogreg',
           'CelerWeightedElasticNet',
           'WeightedElasticNet',
           'WeightedSparseLogReg']
