...
from sparse_ho.criterion.held_out import _copy_state_value
...
class FiniteDiffMonteCarloSure(BaseCriterion):
    ...
    def save_state(self):
        return {
            ...
            "mask02": _copy_state_value(self.mask02),
            "dense02": _copy_state_value(self.dense02),
            "quantity_to_warm_start2": _copy_state_value(
                self.quantity_to_warm_start2),
        }
    ...
    def restore_state(self, state):
        ...
        self.mask02 = _copy_state_value(state["mask02"])
        self.dense02 = _copy_state_value(state["dense02"])
        self.quantity_to_warm_start2 = _copy_state_value(
            state["quantity_to_warm_start2"])
